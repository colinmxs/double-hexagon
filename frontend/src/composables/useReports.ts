...
export const PRE_BUILT_TEMPLATES: PreBuiltTemplate[] = [
  {
    ...
    columns: ['status', 'source_type', 'parent_guardian.last_name', 'referring_agency.agency_name'],
    group_by: 'status',
    sort_by: 'status',
    sort_order: 'asc',
    filters: [],
  ...
  {
    nameKey: 'reports.tplDigitalVsUpload',
    columns: ['source_type', 'status', 'parent_guardian.last_name', 'overall_confidence_score'],
  ...
  {
    nameKey: 'reports.tplTransportationNeeds',
    columns: ['parent_guardian.last_name', 'parent_guardian.phone', 'parent_guardian.city', 'parent_guardian.transportation_access'],
    group_by: 'parent_guardian.transportation_access',
    sort_by: 'parent_guardian.last_name',
    sort_order: 'asc',
    filters: [{ field: 'status', operator: 'in_list', value: ['manually_approved'] }],
  },
]
