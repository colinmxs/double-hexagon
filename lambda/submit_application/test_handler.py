...
- Status set to needs_review for digital submissions
...
class TestSuccessfulSubmission:
    ...
    def test_returns_201_with_application_id(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
        ...
        assert body["reference_number"] == "2025-0001"
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_stores_record_in_dynamodb(self, mock_year, mock_ref, mock_table, mock_audit):
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_all_field_confidence_values_are_1(self, mock_year, mock_ref, mock_table, mock_audit):
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_children_get_child_ids(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_audit_log_recorded(self, mock_year, mock_ref, mock_table, mock_audit):
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_height_stored_as_number(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
...
class TestErrorHandling:
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_dynamodb_write_failure_returns_500(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_audit_failure_does_not_block_submission(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
...
class TestMultipleChildren:
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_multiple_valid_children_succeed(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
    ...
    @patch("handler.generate_reference_number", return_value="2025-0001")
    @patch("handler._get_active_giveaway_year", return_value="2025")
    def test_field_confidence_covers_all_children(self, mock_year, mock_ref, mock_table, mock_audit):
        from handler import handler
