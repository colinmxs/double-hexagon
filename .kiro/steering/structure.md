...
├── docker-compose.yml              # Container orchestration + env var passthrough
├── entrypoint.sh                   # Bootstraps Git PAT + AWS creds on start
...
- Git commands run on the host, everything else runs inside the Docker container
