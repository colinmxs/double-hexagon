...
export class StorageStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Applications table — stores all application records keyed by application_id (ULID)
    ...
    this.applicationsTable.addGlobalSecondaryIndex({
      ...
      partitionKey: { name: 'reference_number', type: dynamodb.AttributeType.STRING },
    });

    // Audit Log table — PK: resource_id, SK: timestamp, GSI: user-index
