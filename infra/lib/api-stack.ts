...
export class ApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    this.submitApplicationFn = new lambda.Function(this, 'SubmitApplicationFn', {
      ...
      description: 'Accepts public application form submissions, validates fields, stores in DynamoDB',
    ...
    configTable.grantReadWriteData(this.submitApplicationFn);
    ...
    this.generatePresignedUrlFn = new lambda.Function(this, 'GeneratePresignedUrlFn', {
      ...
      description: 'Generates S3 presigned upload URLs for paper application scans',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    configTable.grantReadData(this.generatePresignedUrlFn);
    ...
    this.processDocumentFn = new lambda.Function(this, 'ProcessDocumentFn', {
      ...
      description: 'OCR pipeline — Textract extraction, Bedrock interpretation, drawing cropping',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    configTable.grantReadWriteData(this.processDocumentFn);
    ...
    this.processDocumentFn.addToRolePolicy(new iam.PolicyStatement({
      ...
      resources: [
        ...
        `arn:aws:bedrock:us-*::foundation-model/anthropic.claude-opus-4-6-v1`,
      ],
    }));
    ...
    this.getApplicationsFn = new lambda.Function(this, 'GetApplicationsFn', {
      ...
      description: 'Lists applications with filtering by year, status, and search',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    configTable.grantReadData(this.getApplicationsFn);
    documentsBucket.grantRead(this.getApplicationsFn);
    ...
    this.getApplicationDetailFn = new lambda.Function(this, 'GetApplicationDetailFn', {
      ...
      description: 'Returns full application detail with presigned URLs for documents and drawings',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.getApplicationDetailFn);
    ...
    this.updateApplicationFn = new lambda.Function(this, 'UpdateApplicationFn', {
      ...
      description: 'Updates application fields, status, bike numbers, and drawing keywords',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.updateApplicationFn);
    ...
    this.exportDataFn = new lambda.Function(this, 'ExportDataFn', {
      ...
      description: 'Exports bike build lists and family contact lists as CSV',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    configTable.grantReadData(this.exportDataFn);
    usersTable.grantReadData(this.exportDataFn);
    ...
    this.manageReportsFn = new lambda.Function(this, 'ManageReportsFn', {
      ...
      description: 'CRUD for saved report configurations',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.manageReportsFn);
    ...
    this.runReportFn = new lambda.Function(this, 'RunReportFn', {
      ...
      description: 'Runs ad-hoc reports with filters, grouping, sorting, and CSV export',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    configTable.grantReadData(this.runReportFn);
    ...
    this.getCostDataFn = new lambda.Function(this, 'GetCostDataFn', {
      ...
      description: 'Returns AWS cost breakdown by service from Cost Explorer',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.getCostDataFn);
    ...
    this.manageUsersFn = new lambda.Function(this, 'ManageUsersFn', {
      ...
      description: 'Admin user management — create, update, disable, enable, delete',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    this.getAuditLogFn = new lambda.Function(this, 'GetAuditLogFn', {
      ...
      description: 'Queries audit log entries with filtering by user, action, and date range',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.getAuditLogFn);
    ...
    this.manageGiveawayYearFn = new lambda.Function(this, 'ManageGiveawayYearFn', {
      ...
      description: 'Manages giveaway year lifecycle — create, set active, archive, delete',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
    ...
    usersTable.grantReadData(this.manageGiveawayYearFn);
    ...
    this.getAuthMeFn = new lambda.Function(this, 'GetAuthMeFn', {
      ...
      description: 'Returns the authenticated users profile from Cognito JWT claims',
      runtime: lambda.Runtime.PYTHON_3_12,
      handler: 'handler.handler',
